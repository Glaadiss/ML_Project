...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb 24 13:06:08 2019
...
r = np.arange(1,smallPca.shape[1]+1)
plt.bar(r, np.std(smallPca,0))
plt.xticks(r, cityNames)
...
Y1 = (smallPca - np.ones((N,1))*smallPca.mean(axis=0)) / (np.ones((N,1))*smallPca.std(axis=0))
